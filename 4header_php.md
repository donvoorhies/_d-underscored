...
- Keep `aria-controls` and `aria-expanded` attributes unchanged for accessibility.
- If your child/derived theme uses a different text domain, replace `_d-underscored` consistently.
- After editing `header.php`, test keyboard navigation and menu toggle on a mobile viewport.
